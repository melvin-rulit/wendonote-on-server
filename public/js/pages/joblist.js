    ...
    if (modal.options.new_job != true) {
      $.post('/ajax/getJobData',
        ...
        function (data) {
          ...
          $("#job_date").val(formatDate(new Date(data.job.calendar__event.creation)));
